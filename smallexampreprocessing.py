...
if __name__ == '__main__':
    for yearfolder in os.listdir(r"C:\Users\Public\Appdata\Exams\Hebrew"):
        for pdffile in os.listdir(r"C:\Users\Public\Appdata\Exams\Hebrew"+'\\'+yearfolder):
            answer,pagelist,gradingkey=preprocessing(r"C:\Users\Public\Appdata\Exams\Hebrew"+'\\'+yearfolder+'\\' + pdffile)
            dirpath=opendir(r"C:\Users\Public\Appdata\Exams\Hebrew"+'\\'+yearfolder+'\\' + pdffile)
            ...
            shutil.copy(r"C:\Users\Public\Appdata\Exams\Hebrew"+'\\'+yearfolder+'\\' + pdffile,dirpath+r'\\exam.pdf')