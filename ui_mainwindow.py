...
from PySide6.QtWidgets import (QApplication, QHeaderView, QMainWindow, QMenu,
                               ...
                               QWidget)
from PySide6.QtWidgets import QWidget, QPushButton, QApplication, QListWidget, QGridLayout, QLabel, QProgressBar
...
class WinForm(QWidget):
    ...
    def refreshr(self):
        if (self.timer.isActive()):
            self.label.setText(
                str(self.timer.remainingTime() / 60000)[0:2] + ":" + str((self.timer.remainingTime() % 60000) / 1000)[
                                                                     0:2])
            self.savedtime = self.timer.remainingTime()
        else:
            pass
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bookmarkTab.setObjectName(u"answers")
    ...
    def retranslateUi(self, MainWindow):
        ...
        # endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.bookmarkTab),
                                  QCoreApplication.translate("MainWindow", u"answers", None))
